...
export const translations = {
  uk: {
    ...
    footerCompanyDesc: 'Команда Aivixtech впроваджує готові IT-рішення та надпотужне, компактне обладнання для модернізації українського бізнесу і державних установ.',
    emailSales: 'Відділ продажів',
    emailSupport: 'Підтримка замовлень',
    emailService: 'Сервісний центр',
    headerWorkingHours: 'Пн - Пт / 9:00 - 18:00',
    paymentDelivery: 'Оплата і доставка',
    filterOffersTitle: 'Спеціальні пропозиції',
    productSpecsOriginal: 'Ви можете ознайомитися з більш детальними технічними характеристиками на першоджерелі:',
  ...
  en: {
    ...
    footerCompanyDesc: 'The Aivixtech team implements ready-made IT solutions and ultra-powerful, compact equipment for the modernization of Ukrainian business and government institutions.',
    emailSales: 'Sales department',
    emailSupport: 'Order support',
    emailService: 'Service center',
    headerWorkingHours: 'Mon - Fri / 9:00 - 18:00',
    paymentDelivery: 'Payment & Delivery',
    filterOffersTitle: 'Special Offers',
    productSpecsOriginal: 'You can find more detailed technical specifications on the original source:',
